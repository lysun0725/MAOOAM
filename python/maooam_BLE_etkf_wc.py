...
gainfile = '../fortran_da/gain_etkf_a_%s_%s_%3.1f%s.dat' % (exp, str(ens_num),infl,tw_da_s)
gainfile2 = '../fortran_da/gain_etkf_o_%s_%s_%3.1f%s.dat' % (exp, str(ens_num),infl,tw_da_s)
...
# save LEhist
np.savetxt('LEhist_etkf_%s_%s_%3.1f%s.dat' % (exp,str(ens_num),infl,tw_da_s),LEhist*(86400*f0))
