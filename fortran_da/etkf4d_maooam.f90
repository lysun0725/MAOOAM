PROGRAM etkf_maooam
  ...
  USE stat
  USE m_da_maooam, only: etkf,etkf4d
  USE m_mt,     only: randn
  ...
  REAL(KIND=8),DIMENSION(:,:,:),ALLOCATABLE :: Xens_hist   
  REAL(KIND=8),DIMENSION(:,:),ALLOCATABLE :: R_hist   

  INTEGER :: i,j,k,l,nn,m,cnt_obs,ntda,cnt_hist=1
  INTEGER :: Ho, Po, total
  INTEGER :: nt, nseed
